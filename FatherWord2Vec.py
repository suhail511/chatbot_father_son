...
# if (os.path.isfile('data/FatherWord2VecXTrain.npy') and os.path.isfile('data/FatherWord2VecYTrain.npy') and os.path.isfile('data/FatherWordList.txt')):
# 	xTrain = np.load('data/FatherWord2VecXTrain.npy')
# 	yTrain = np.load('data/FatherWord2VecYTrain.npy')
